...
appointmentStatus:
summary.appointmentStatus || [],



available:
medicines.filter(
m=>Number(m.stockQuantity)>10
).length,
...
<AppointmentChart 
data={dashboard.appointmentStatus}
/>
...
<PatientGrowthChart 
data={chartsData.patientGrowth}
/>


<DepartmentDoctorsChart 
data={chartsData.doctorsByDepartment}
/>


<MedicineStockChart 
data={chartsData.medicineStock}
/>


<RoomOccupancyChart 
data={chartsData.roomOccupancy}
/>
...
<p className="empty-text">
No emergency patients currently admitted.
</p>
