    ...
    return (
        <div className="list-container">
            <div className="list-header">
                <h2 style={{ color: "red" }}>TEST USER MANAGEMENT</h2>
...
[System.IO.File]::WriteAllText("$PWD\src\components\UserManagement.jsx", $content, [System.Text.Encoding]::UTF8)
Write-Host "UserManagement.jsx তৈরি হয়ে গেছে!" -ForegroundColor Green